...
> 目前版本：**0.40.0**（M10.0 — 雙模式 UI/UX 流程互動 prototype）
...
| **M10.0** | **雙模式 UI/UX 流程互動 prototype：一鍵全自動 + 手動素材決策 / AI 初稿清單 / 進階時間軸分層驗證** | ✅ done | **0.40.0** |
| M10.1 | 多專案批次 + 社群直接發布 + AI 自動縮圖 | 🔮 future | 0.40.x+ |
