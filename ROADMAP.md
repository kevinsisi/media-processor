...
> 目前版本：**0.28.3**（M9.13.3 — 背景任務生命週期強化：enqueue 失敗不卡 pending、watchdog 擴到 export/BGM/point tracking/analysis、stale worker 不覆蓋 terminal state）
...
- `/projects/:id/edit` ready state 新增「發佈工作台」：預覽、下載主成品、匯出 IG/FB 版本、重新生成一版成為第一層操作；片段順序、字幕、配樂、浮水印微調收成次要進階區。
