...
> 目前版本：**0.29.0**（M9.14 — 比例縮減為 9:16 + 16:9（4:5 / 1:1 退役）、新增來源 ↔ 輸出方向不同時的靜態裁切錨點選擇器）
> 下一個 milestone：**M9.15 / 0.30.0** — AI Smart Camera（AI 智慧運鏡），預設關閉，opt-in 才生效。
...
| **M9.15** | **AI Smart Camera（AI 智慧運鏡）— Gemini Vision 重點區域 + 動態縮放/平移 + 節拍同步，預設關閉** | 🚧 planned | **0.30.0** |
...
## 🚧 Phase 9.15（M9.15）— AI Smart Camera / AI 智慧運鏡（0.30.0，規劃中）
